...
public class WebUserExaminationController {
	...
	public ResponseEntity<CommonResponse> getUserExamination(@RequestParam("searchText") Optional<String> searchText,
		...
		UserExaminationResponseDto result = webUserExaminationService 
				.getUserExaminationWithAdmin(searchText.orElse("_"), startDate, endDate, pageable);
	...
	public ResponseEntity<CommonResponse> setConsentFormExistYn(
			@PathVariable("userExaminationId") Long userExaminationId,
			@RequestParam("isConsentFormExistYn") Integer isConsentFormExistYn) {
