...
@NoArgsConstructor
@AllArgsConstructor
@IdClass(StatisticsMonthlyId.class)
@Entity
public class StatisticsMonthly extends BaseEntity implements StatisticsInterface {
    ...
    public long getAgreeYCount() {
        return this.agreeYCount;
    }

    @Override
    public long getAgreeNCount() {
        return this.agreeNCount;
    }
